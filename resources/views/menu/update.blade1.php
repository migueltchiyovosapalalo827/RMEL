                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" value="{{$menu->nome}}" placeholder="{{'nome'}}" autocomplete="off">
                           @error('nome')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{$menu->icon}}" placeholder="{{'icone'}}" autocomplete="off">
                           @error('icon')
                            <div class="invalid-feedback">
                                <h6>{{$message}}</h6>
                            </div>
